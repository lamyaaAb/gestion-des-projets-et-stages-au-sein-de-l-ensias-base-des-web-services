        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              <h2><?php echo $_SESSION['prenom_encadrant']." ".$_SESSION['nom_encadrant'] ?></h2>
              <h3>Encadrant</h3>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['nom_encadrant'] ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Prénom</div>
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['prenom_encadrant'] ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['email_encadrant'] ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Type d'encadrant</div>
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['type_encadrant'] ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Etablissement</div>
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['etab_encadrant']?></div>
                  </div>
