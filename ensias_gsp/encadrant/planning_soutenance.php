...
//recupération des evenements des projets 
     ...
     $stmt2=$db->prepare('select * from soutenance where idProjet in (select idProjet from projetencadrant where idEncadrant=:idenc)');
     $stmt2->execute(array( 'idenc'=>$_SESSION['id_encadrant']));
