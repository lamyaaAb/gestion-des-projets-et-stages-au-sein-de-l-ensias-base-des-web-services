...
session_start();
$email=$_SESSION['email_encadrant'];
...
if(! empty($_FILES['file']['name'])) {
  ...
  if(move_uploaded_file($file_tmp_name,$file_dest)){
    ...
    $stmt->execute(array(
      'emailEncadrant' =>$_POST['email'],     //etudiant:emmeteur
      'emailEtudiant'=>$email,               //recepteur:encadrant
      'texte'=>$_POST['message'],
      'lien'=>$file_dest
     ));
  }
...
<div class="col-md-12">
  <input class="form-control" type="text" name="email"  placeholder="Email de votre destinataire" required>
</div>
