...
{
  $id_etd= $_SESSION['id'];
  $projet = file_get_contents("http://localhost/Projet-PFA/ensias_gsp/php_rest/api/stage/readun.php?id_etd=$id_etd");
  $response = json_decode($projet,true); 
if(isset($response['data'])) 
  { //ze3ma lweb service rejee3 lina shi objet
    
      $_SESSION['sujet_stage']=$response['data'][0]['sujet'];
      $_SESSION['description_stage']=$response['data'][0]['description'];
      $_SESSION['date_fin_stage']=$response['data'][0]['date_fin'];
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-17">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Votre projet de stage</h5>
              ...
              <form>
                <div class="row mb-7">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php if(!isset($_SESSION['sujet_stage']))
                                                                              $_SESSION['sujet_stage']="  "; echo  $_SESSION['sujet_stage'] ?>">
                  </div>
                </div><br>
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">La description du projet</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" style="height: 100px"><?php if(!isset($_SESSION['description_stage']))
                                                                              $_SESSION['description_stage']="  "; echo  $_SESSION['description_stage'] ?></textarea>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label">Date de fin de projet </label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control" value="<?php if(!isset($_SESSION['date_fin_stage']))
                                                                              $_SESSION['date_fin_stage']="  "; echo  $_SESSION['date_fin_stage'] ?>">
                  </div>
                </div>
            </div>
          </div>
