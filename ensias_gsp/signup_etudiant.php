...
if (isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['cne']) && isset($_POST['email']) && isset($_POST['mdp']) &&  isset($_POST['filiere'] ))
{   
    $nom=$_POST['nom'];
    $prenom =$_POST['prenom'];
    $cne = $_POST['cne'];
    ...
    $etudiant = file_get_contents("http://localhost/Projet-PFA/ensias_gsp/php_rest/api/etudiant/create.php?nom=$nom&prenom=$prenom&cne=$cne&email=$email&mdp=$mdp&filiere=$filiere");
                ...
                <div class="section-title">
                  ...
                  <div >
                    ...
                    <form action="" method="post"  >
                      ...
                      <div class="form-group mt-3">
                          <input type="text" name="cne" class="form-control" id="cne" placeholder="CNE" required>
                        </div>
                      <div class="form-group mt-3">
                        <input type="text" class="form-control" name="mdp" id="mdp" placeholder="Mot de passe" required>
                      </div>
                      <div class="form-group mt-3">
                        <input type="text" class="form-control" name="filiere" id="filiere" placeholder="Filière" required>
                      </div>
