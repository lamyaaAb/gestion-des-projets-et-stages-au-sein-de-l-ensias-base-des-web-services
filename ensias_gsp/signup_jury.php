...
if (isset($_POST['nom']) && isset($_POST['prenom'])  && isset($_POST['email']) && isset($_POST['mdp']) && isset($_POST['filiere']))
{   
    $nom=$_POST['nom'];
    $prenom =$_POST['prenom'];
    $email =$_POST['email'];
    ...
    $chef = file_get_contents("http://localhost/Projet-PFA/ensias_gsp/php_rest/api/membrejury/create.php?nomMembre=$nom&prenomMembre=$prenom&emailMembre=$email&mdpMembre=$mdp&filiere=$filiere");
    $response = json_decode($chef,true); 
