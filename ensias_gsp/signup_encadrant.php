...
{   
    ...
    $encadrant = file_get_contents("http://localhost/Projet-PFA/ensias_gsp/php_rest/api/encadrant/create.php?nom=$nom&prenom=$prenom&email=$email&mdp=$mdp&etablissement=$etablissement&filiere=$filiere");
