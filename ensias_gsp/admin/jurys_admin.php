...
$stmt=$connect->prepare('SELECT * from membrejury where validite is NULL order by idMembreJury');
$stmt->execute();
...
<body>
        ...
        <section class="section">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Table des membres des jurés</h5>
    ...
    while($row=$stmt->fetch(PDO::FETCH_ASSOC))
  {
   ?>
     ...
     <tr>
     <td><?php echo $row['nomMembre']; ?></td>
     <td><?php echo $row['prenomMembre']; ?></td>
     <td><?php echo $row['emailMembre']; ?></td>      
     <td>
     <a href="validerjury.php?id=<?php echo ($row['idMembreJury']);?> " ><button class="btn btn-primary" name="decider" type="button">Valider</button></a>

     </td>
     <td>
     <a href="nonvaliderjury.php?id=<?php echo ($row['idMembreJury']);?> " ><button class="btn btn-primary" name="decider" type="button">Non valider</button></a>
