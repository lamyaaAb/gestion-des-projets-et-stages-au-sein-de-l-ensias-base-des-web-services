...
$stmt=$connect->prepare('SELECT * from cheffiliere where validite is NULL order by idCF');
$stmt->execute();
...
<body>
        ...
        <section class="section">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Table des chefs des filières</h5>
    ...
    while($row=$stmt->fetch(PDO::FETCH_ASSOC))
  {
   ?>
     ...
     <tr>
     <td><?php echo $row['nomCF']; ?></td>
     <td><?php echo $row['prenomCF']; ?></td>
     <td><?php echo $row['emailCF']; ?></td>      
     <td>
     <a href="validerCF.php?id=<?php echo ($row['idCF']);?> " ><button class="btn btn-primary" name="decider" type="button">Valider</button></a>

     </td>
     <td>
     <a href="nonvaliderCF.php?id=<?php echo ($row['idCF']);?> " ><button class="btn btn-primary" name="decider" type="button">Non valider</button></a>
